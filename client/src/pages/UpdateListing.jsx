...
function UpdateListing() {
    ...
    const handleSubmit=async (e)=>{
        ...
        try{
            setLoading(true);
            setError(false);
            const listing_details={...formData,userRef:currentUser._id}
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-wrap gap-6'>
                <div className="flex items-center gap-2">
                    <input type='number' id="bedrooms" className='p-3 border border-gray-300 rounded-lg' 
                ...
                {formData.offer && (
                                    ...
                                    className='p-3 border border-gray-300 rounded-lg' min='0' max="1000000" required
                                    onChange={handleChange}
                                    />
                                    <div className='flex flex-col'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                className='p-3 border border-gray-300 rounded w-full' id='images' accept='image/*' multiple/>
                <button 
                type='button'
                disabled={uploading}
            ...
            <p className='text-red-700'>{imageUploadError && imageUploadError}</p>
            {
                formData.imageUrls.length>0 && formData.imageUrls.map((url,index)=>
                    ...
                    <div key={url} className='flex justify-between p-3 border items-center'>
                        ...
                        <button type='button' onClick={()=>handleDeleteImage(index)} className='p-3 text-red-700 rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>Delete</button>
                    </div>
                )
            }
            <button 
